 ...
 * or checksum mismatch. Ports the error conditions raised by the Python
 * reference's {@code GenericFileValidator.validate} (see
 * {@code deployments/original-data-to-bigqueryload/src/data_ingestion/validation/file_validator.py:56-122}
 * in the main gcp-pipeline-reference checkout).
 */
