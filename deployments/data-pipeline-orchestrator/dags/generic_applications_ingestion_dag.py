...
"""
Generic Applications Ingestion DAG

Runs Dataflow to load applications data to BigQuery ODP, reconciles,
...
DAG_ID = "generic_applications_ingestion_dag"
...
generic_applications_ingestion_dag = DAG(
    dag_id=DAG_ID,
...
with generic_applications_ingestion_dag:
