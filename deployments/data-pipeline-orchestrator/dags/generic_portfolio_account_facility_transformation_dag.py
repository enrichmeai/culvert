...
"""
Generic portfolio_account_facility Transformation DAG

Transforms ODP to FDP for portfolio_account_facility — runs per-model based on granular dependencies.
...
DAG_ID = "generic_portfolio_account_facility_transformation_dag"
...
generic_portfolio_account_facility_transformation_dag = DAG(
    dag_id=DAG_ID,
...
with generic_portfolio_account_facility_transformation_dag:
