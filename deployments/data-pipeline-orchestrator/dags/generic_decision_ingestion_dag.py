...
"""
Generic Decision Ingestion DAG

Runs Dataflow to load decision data to BigQuery ODP, reconciles,
...
DAG_ID = "generic_decision_ingestion_dag"
...
generic_decision_ingestion_dag = DAG(
    dag_id=DAG_ID,
...
with generic_decision_ingestion_dag:
