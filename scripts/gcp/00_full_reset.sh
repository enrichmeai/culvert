...
echo ""
echo "  # Then install Airflow on GKE (orchestrator Helm chart)"
echo "  helm dependency build deployments/data-pipeline-orchestrator/helm"
echo "  helm install airflow deployments/data-pipeline-orchestrator/helm \\"
