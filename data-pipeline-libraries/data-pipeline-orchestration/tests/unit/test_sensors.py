...
from data_pipeline_orchestration.sensors.pubsub import BasePubSubPullSensor, PubSubCompletionSensor
from data_pipeline_orchestration.sensors.dataflow import DataflowStreamingSensor
from data_pipeline_orchestration.hooks.secrets import SecretManagerHook

class TestOrchestrationSensors:
    @patch('data_pipeline_orchestration.sensors.pubsub.BasePubSubPullSensor.execute')
    ...
    def test_secret_manager_hook(self, mock_client_cls):
        ...
        with patch('data_pipeline_orchestration.hooks.secrets.AIRFLOW_AVAILABLE', False):
...
class TestBasePubSubPullSensorPoke:
    ...
    @patch('data_pipeline_orchestration.sensors.pubsub.PubSubHook')
