...
from data_pipeline_orchestration.factories.dag_factory import (
    create_dags,
    _entity_names,
    _fdp_dependencies,
    _resolve_infra,
...
def mock_airflow_variable():
    ...
    with patch("data_pipeline_orchestration.factories.dag_factory.Variable") as mock_var, \
         patch("data_pipeline_orchestration.factories.dag_factory.BaseDataflowOperator", _StubDataflowOperator):
...
class TestIngestionCallables:
    def test_check_ready_fdp_models_all_loaded(self, system_config, mock_airflow_variable):
        ...
        with patch("data_pipeline_orchestration.factories.dag_factory.EntityDependencyChecker") as mock_checker_cls:
