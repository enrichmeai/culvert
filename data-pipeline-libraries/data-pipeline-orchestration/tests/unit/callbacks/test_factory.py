...
from data_pipeline_orchestration.callbacks.factory import ErrorHandler
...
class TestErrorHandler(unittest.TestCase):
    ...
    @patch('data_pipeline_orchestration.callbacks.factory.publish_to_dlq')
    ...
    @patch('data_pipeline_orchestration.callbacks.factory.on_failure_callback')
