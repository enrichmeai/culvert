# Application1 (Application A) - Terraform Variables
...
# ============================================================================
# Application1 SPECIFIC CONFIGURATION
# ============================================================================

variable "application1_entities" {
  description = "List of Application1 entities"
  type        = list(string)
