...
> The legacy Python trees (`gcp-pipeline-libraries/`, the `gcp_pipeline_*` egg-info) belong to an earlier internal iteration and are being removed — see [Legacy](#legacy).
