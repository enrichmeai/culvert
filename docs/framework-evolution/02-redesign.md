...
These eleven protocols are the entire framework-to-cloud seam. Anything that needs to be cloud-specific touches one of them and lives in a `data-pipeline-<cloud>-*` module. Anything that does not need to be cloud-specific does not.
