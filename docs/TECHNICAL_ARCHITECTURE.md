...
The Enterprise Transformation paved path (currently **under test**) enables teams to run dbt on Cloud Run, providing a dedicated repo and a pipeline to push dbt projects to GCS.
