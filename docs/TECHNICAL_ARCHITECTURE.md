...
To reduce GCP costs and management complexity, the framework consolidates what were previously separate applications (Application A and Application B) into **three functional deployment units**:
